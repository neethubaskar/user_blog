...
class UserRegistrationAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            self.response_data["message"] = "User has been registered successfully."
...
class UserLoginAPIView(APIView):
    ...
    def post(self, request):
        ...
        if user:
            ...
            self.response_data["status"] = "success"
            self.response_data["token"] = token.key
            return Response(self.response_data, status=status.HTTP_200_OK)
        
        self.response_data["status"] = "failed"
        self.response_data["error"] = "Invalid credentials"
...
class UserLogoutAPIView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            logout(request)
            self.response_data["status"] = "success"
            self.response_data["message"] = "Successfully logged out."
            return Response(self.response_data, status=status.HTTP_200_OK)
